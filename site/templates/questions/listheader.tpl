    ...
    <div id="question">
        <table class="question-table" style="width:100%;">
            ...
            <tr>
                <td style="padding:1rem; "><a href="#"
                    ...
                    <p style="padding-left:1rem; font-size:60%; float:left;">asked {$question.timeago}</p></td>
        ...
        <div id="tagsofquestion">
            {foreach $question.tagarray as $tag}
                <a class="Taag btn btn-danger" role="button"><span class="glyphicon glyphicon-tag"></span>{$tag}</a>
            {/foreach}
        </div>
    </div>
    <hr>
